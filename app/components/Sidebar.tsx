...
import { Home, Music, Settings, LogOut, TrendingUp, ListMusic, Volume2, FileSearch, Menu, X, Library, HelpCircle, Download, Tag, Play } from 'lucide-react';
  ...
  const sidebarContent = (
    <>
      ...
      <div className="flex-1 p-3 md:p-4 space-y-1 overflow-y-auto">
        ...
        <NavItem href="/tags" icon={<Tag className="w-4 h-4" />} label="Tag Suggestions" active={pathname === '/tags'} />
        ...
        <NavItem href="/cue-points" icon={<Play className="w-4 h-4" />} label="Cue Points" active={pathname === '/cue-points'} />
