      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto p-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-semibold text-white mb-2 tracking-tight">Mixes & Sets</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mixes.map((mix) => (
              <div
                key={mix.id}
                className="bg-[#1a1a22] rounded-xl p-6 border border-white/8 shadow-lg hover:border-white/12 transition-all cursor-pointer group"
              >
